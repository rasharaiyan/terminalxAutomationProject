pipeline {
    ...
    steps {
        script {
            ...
            bat "call ${VENV_DIR}\\Scripts\\activate"
            bat "set PYTHONPATH=%PYTHONPATH%;${PROJECT_ROOT} && call ${VENV_DIR}\\Scripts\\python -m pytest ${PROJECT_ROOT}\\tests\\api_tests\\test_api_add_item_to_cart_functionality --html=${PROJECT_ROOT}\\${HTML_REPORT_DIR}\\report.html --self-contained-html"
